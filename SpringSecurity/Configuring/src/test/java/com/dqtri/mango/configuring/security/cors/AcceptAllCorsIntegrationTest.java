...
import com.dqtri.mango.configuring.security.cors.config.AcceptAllSecurityCorsConfig;
...
@WebMvcTest(controllers = {SubmissionController.class},
        includeFilters = @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, classes = AcceptAllSecurityCorsConfig.class))
public class AcceptAllCorsIntegrationTest extends AbstractIntegrationTest {
